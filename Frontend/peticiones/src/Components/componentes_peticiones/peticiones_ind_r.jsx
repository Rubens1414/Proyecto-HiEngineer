...
function Peticiones_ind_r({peticiones}) {
  ...
  return (
    <div>    {isAdmin===true && peticiones.estado==='Cancelado' &&(
        <div>
        <div className="flex justify-center ">
         ...
         <div  className="flex flex-col mx-2 mb-16">
            <div className="contenedor_iconos_en_rechazo">
           
   
            <FontAwesomeIcon icon={faRectangleXmark}  flip className="text-8xl text-red-500"  />
        ...
        {(isOpen === true) && (
           ...
           >
             ...
             >
             <div className="flex justify-end  bg-red-500 py-1 px-4  rounded-t-lg">
...
export default Peticiones_ind_r