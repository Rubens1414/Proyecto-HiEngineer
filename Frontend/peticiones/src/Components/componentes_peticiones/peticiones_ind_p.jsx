...
function Peticiones_ind_p({peticiones}) {
  ...
  return (
    <div>
            {isAdmin===true && peticiones.estado==='En proceso' &&(
             <div>
             <div className="flex justify-center ">
              ...
              <div  className="flex flex-col mx-2 mb-16">
                 <div className="contenedor_iconos_en_proceso">
                
        
                 <FontAwesomeIcon icon={faBusinessTime}  shake className="text-8xl text-yellow-500"  />
             ...
             {(isOpen === true) && (
                ...
                >
                  ...
                  >
                  <div className="flex justify-end  bg-yellow-500 py-1 px-4  rounded-t-lg">
                    ...
                    <div className="flex flex-row justify-center ">
                     ...
                     <button className="boton_edit_peticion_proceso" onClick={Aceptar} >
...
export default Peticiones_ind_p