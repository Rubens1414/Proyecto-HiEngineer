...
function Peticiones_ind_f({peticiones}
) {
  ...
  return (
    <div>   {isAdmin===true && peticiones.estado==='Falso' &&(
        <div>
        <div className="flex justify-center ">
         ...
         <div  className="flex flex-col mx-2 mb-16">
            <div className="contenedor_iconos_falsos">
           
   
            <FontAwesomeIcon icon={faClipboardQuestion}  fade className="text-8xl text-gray-500"  />
        ...
        {(isOpen === true) && (
           ...
           >
             ...
             >
             <div className="flex justify-end  bg-gray-500 py-1 px-4  rounded-t-lg">
               ...
               <div className="flex flex-row justify-center ">
                ...
                <button className="boton_edit_peticion_falso" onClick={Aceptar} >
...
export default Peticiones_ind_f