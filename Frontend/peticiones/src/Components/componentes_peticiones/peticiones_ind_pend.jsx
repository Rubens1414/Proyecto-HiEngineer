...
function Peticiones_ind_pend({peticiones}) {
  ...
  return (
    <div>
    {isAdmin===true &&  peticiones.estado=='Pendiente' &&(
          <div>
          <div className="flex justify-center ">
           ...
           <div  className="flex flex-col mx-2 mb-16">
              <div className="contenedor_iconos_pendientes">
              <FontAwesomeIcon icon={faHand} shake className="text-8xl text-yellow-400" />
              <FontAwesomeIcon icon={faExclamation} bounce className="text-8xl text-red-400"/>
              </div>
              <div className="-mt-28">
              <h1 className="text-2xl gugi text-red-700">{peticiones.nombre}</h1>
          ...
          {(isOpen === true) && (
                ...
                >
                  ...
                  >
                  <div className="flex justify-end  bg-blue-500 py-1 px-4  rounded-t-lg">
                    ...
                    <div className="flex flex-col "  >
                     <div className="flex flex-col mt-6 text-red-600 m-8 my-2 p-4 shadow-md">
                      ...
                      <button className="boton_aceptar_peticion" onClick={Aceptar} >
                      <FontAwesomeIcon icon={faCheck} shake  />Aceptar
                     </button>
                      </div>
...
export default Peticiones_ind_pend